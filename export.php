<?php
	...
	header("Content-Disposition: attachment; filename=HasilPolling.xls");
?>
                ...
                <div class="col-lg-12">
                    <div class="panel panel-default">
                        <div class="panel-heading">
                            <p><b>Pengolahan Sistem Polling Perusahaan yang bekerja sama dengan Dinas Perhubungan Provinsi Riau</b></p>
                        </div>
                    ...
                    ?>
                            ...
                            <?php $nrr=$average1+$average2+$average3+$average4+$average5; ?>
                              ...
                              <table border="1" width="100%" class="table table-striped table-bordered table-hover" id="dataTables-example">
                                <tr>
                                     <td width="100%"></td>
                                     <td><b> Jumlah NRR Poll tertimbang </b></td>
                                     <td><center><b><?php echo number_format($nrr,2);?></b></center></td>
                                </tr>

                                <tr>
                                     <td width="100%"></td>
                                     <td><b> Nilai Poll (JML NRR Poll tertimbang *25) </b></td>
                                     <td><center><b><?php echo number_format(($ikm=$nrr*25),2);?></b></center></td> 
                                </tr>
                                <tr>
                                     <td width="100%"></td>
                                     <td><b> Keterangan Hasil Penilaian Poll</b></td>
                                     <td><center><b>Sangat Baik : 85 - 100 <br> Baik : 65 - 84 <br> Cukup Baik : 45 - 64 <br> Kurang Baik : 1 - 44 </b></center></td> 
                                </tr>   
                                </tbody>
                            </table>
