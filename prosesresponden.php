<?php
	...
	$form1 = mysqli_query($connect,"INSERT INTO responden (	id_responden,tanggal,perusahaan,nama,nip,umur,jenis_kelamin,pendidikan,pekerjaan,id_kategoriResponden)
	VALUES('','$tanggal','$perusahaan','$nama','$nip','$umur','$jkelamin','$pendidikan','$pekerjaan','$id_kategorisend')");
