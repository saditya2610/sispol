...
<?php
    ...
    if ($sql == TRUE) {
		?>
			<script language="javascript">alert("Survei Polling Berhasil Terekam, Terima Kasih Atas Partisipasi Anda.");</script>
			<script>document.location.href='pageUser.php'</script>
<?php	
	} else {
		?>
			<script language="javascript">alert("Survei Polling ada yang belum terisi");</script>
